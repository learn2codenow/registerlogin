...
if (isset($_POST['fname']) and isset($_POST['lname']) and isset($_POST['uname']) and isset($_POST['lname']) and isset($_POST['pwd1']) and isset($_POST['pwd2']) and !empty($_POST['fname']) and !empty($_POST['lname']) and !empty($_POST['uname']) and !empty($_POST['pwd1']) and !empty($_POST['pwd2'])) {
...
if (mysqli_num_rows($res)>0) {
	...
	if ($pwd1 == $pwd2) {
		...
		$sql = "INSERT INTO users (fname, lname, uname, pwd) VALUES ('$fname', '$lname', '$uname', '$pwd1')";
		$res = mysqli_query($conn, $sql);
